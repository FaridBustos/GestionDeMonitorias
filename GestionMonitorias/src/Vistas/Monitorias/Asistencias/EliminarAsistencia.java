...
public class EliminarAsistencia extends javax.swing.JFrame {
     ...
     */
    public EliminarAsistencia(Universidad uni, ArchivoUniversidad arch) {
        initComponents();
        this.uni = uni;
        this.arch = arch;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar Asistencia");

        jLabel2.setText("Codigo materia");

        jLabel3.setText("Codigo monitoria");
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        try {
            ...
            CM.eliminarAsistencia(codigoMateria, codigoMonitoria, codigoEstudiante);
            this.dispose();
            arch.guardar(uni);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new EliminarAsistencia().setVisible(true);
            }
        });
    }
