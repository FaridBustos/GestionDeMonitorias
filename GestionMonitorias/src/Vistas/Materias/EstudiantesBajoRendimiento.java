 ...
 * @author farid
 */
public class EstudiantesBajoRendimiento extends javax.swing.JFrame {

    private Universidad uni;

    /**
     * Creates new form EstudiantesBajoRendimiento
     */
    public EstudiantesBajoRendimiento(Universidad uni) {
        initComponents();
        this.uni = uni;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Estudiantes con bajo rendimiento");
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        ControladorMaterias CM = new ControladorMaterias(uni);
        try {
            ...
            jTable1.setModel(CM.mostrarCaidos(codigoMateria, codigoProfesor));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstudiantesBajoRendimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new EstudiantesBajoRendimiento().setVisible(true);
            }
        });
    }
