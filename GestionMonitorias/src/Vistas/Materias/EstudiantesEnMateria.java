 ...
 * @author Casa Verano
 */
public class EstudiantesEnMateria extends javax.swing.JFrame {
    private Universidad uni;

    /**
     * Creates new form EstudiantesEnMateria
     */
    public EstudiantesEnMateria(Universidad uni) {
        initComponents();
        this.uni = uni;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ver estudiantes en materia");
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        ...
        jTable1.setModel(CM.mostrarEstudiantesEnMateria(codigoMateria));
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstudiantesEnMateria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new EstudiantesEnMateria().setVisible(true);
            }
        });
    }
